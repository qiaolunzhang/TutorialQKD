...
class NetworkEnvironment:
    ...
    def time_driven_auxiliary_graph_shortest_path(self, time_slot, qkp_remaining_keys_dic,
        ...
        for node_index in range(len(shortest_path_nodes_list)-1):
            ...
            if node_int1 != node_int2:
                if quantum_node_flag1 and quantum_node_flag2:
                    if time_slot_index1 not in used_time_slot_list:
                        used_time_slot_list.append(time_slot_index1)
                elif not quantum_node_flag1 and not quantum_node_flag2:
                    if time_slot not in used_time_slot_list:
                        used_time_slot_list.append(time_slot)
        if len(used_time_slot_list) > 1:
            one_time_slot_flag = False
        ...
        # if one_time_slot_flag:
        #     num_physical_hops = num_physical_hops + num_virtual_hops
        #     num_virtual_hops = 0
