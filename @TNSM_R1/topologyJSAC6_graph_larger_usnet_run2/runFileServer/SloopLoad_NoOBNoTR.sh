...
#  python3 run-JLT-heuristic6-NoOBNoTR.py 1 1 1 $i $i &
  /home/qiaoluzh/miniforge3/envs/py38/bin/python3 run-JLT-heuristic6-NoOBNoTR.py 1 1 1 $i $i &
...
wait
echo "All done for all cases of OB"
